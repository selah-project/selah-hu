...
**The Selah Hungarian Rendering** — a Selah betűhű renderelése a
Héber Bibliáról (egy renderelés versenként és egy glossza
szóegységenként), a teljes revíziós történetével együtt.

Kiadva a **Creative Commons Attribution-ShareAlike 4.0 International
...
Az alapul szolgáló héber szöveg az OpenScriptures Hebrew Bible (WLC),
közkincs (public domain). A renderelés, a glosszák, a jelölések és a
revíziós történet a Selah-projekt saját munkája.

---

**The Selah Hungarian Rendering** — Selah's letter-faithful rendering
of the Hebrew Bible (one rendering per verse and one gloss per
